#!/usr/bin/env python3
"""
Aplica extraction_key_value_generic_prompt.yaml a un documento de tipo
desconocido y devuelve un JSON plano con la información disponible, sin
...
DEFAULT_PROMPT = Path(__file__).parent / "extraction_key_value_generic_prompt.yaml"
...
def main():
    parser = argparse.ArgumentParser(description="Extrae información key-value de un documento de cualquier tipo")
