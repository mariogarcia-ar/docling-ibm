...
| **Estado de diseño** | 🟡 Motor declarativo (F0) + R1-R7 y contexto tipado (F3/T-301) + evidencia de lectura (F3/T-302) + reglas raw por fuente (F3/T-303, extendidas en F4/T-403) + precedencia por campo (F4/T-404) implementados; cruzadas/gaps (F5) pendientes |
