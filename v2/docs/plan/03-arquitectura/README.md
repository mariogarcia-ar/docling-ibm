...
| [`EXT.md`](EXT.md) | `voucherflow/extraction/` | Extracción con flujos VLM y LLM en paralelo, reglas raw (pasada 1) y combinación por campo | 🟡 En implementación (T-401 hecho: flujos en paralelo + contrato de evidencia; T-402: normalización key-value; T-403..T-405 pendientes) | F4 (T-401..T-405) |
| [`RULES.md`](RULES.md) | `voucherflow/rules/` | Motor de reglas declarativo: R1-R7, precedencia por campo, fast-fail y gaps | 🟡 R1-R7 + contexto tipado (T-301) + evidencia (T-302) + reglas raw (T-303); precedencia (T-404) y cruzadas/gaps (F5) pendientes | F0 (T-003/ADR-006) + F3 (T-301/T-303) + F5 (T-501/T-502) |
