...
| [`EXT.md`](EXT.md) | `voucherflow/extraction/` | Extracción con flujos VLM y LLM en paralelo, reglas raw (pasada 1) y combinación por campo | 🟡 En implementación (T-401 hecho: flujos en paralelo + contrato de evidencia; T-402..T-405 pendientes) | F4 (T-401..T-405) |
