...
| [`CLAS.md`](CLAS.md) | `voucherflow/classification/` | Tipo/letra (R1-R7 + VLM/LLM) y clasificación contable (cadena 01→02→03) | 🟡 T-301..T-304 implementados; T-305 pendiente | F3 (T-301..T-305) |
