...
| [`EXT.md`](EXT.md) | `voucherflow/extraction/` | Extracción con flujos VLM y LLM en paralelo, reglas raw (pasada 1) y combinación por campo | 🟡 En implementación (T-401: flujos + contrato; T-402: normalización; T-403: reglas raw por fuente; T-404..T-405 pendientes) | F4 (T-401..T-405) |
