...
| [`CONC.md`](CONC.md) | `voucherflow/conclusion/` | Reglas cruzadas → búsqueda de evidencia adicional → agente IA → HITL → consolidación | 🟡 En implementación (T-501..T-505 hechas: reglas cruzadas, búsqueda acotada, consolidación, escalado al agente y cola HITL con muestreo de auditoría; T-506..T-507 pendientes) | F5 (T-501..T-507) |
...
> en **🟡 En implementación** (T-501..T-505 hechos: reglas cruzadas de la pasada 2,
> búsqueda acotada de evidencia, consolidación del `VoucherResult`, escalado al
> agente IA y cola HITL con muestreo de auditoría) y **`RULES.md`** está 🟡 con el motor completo hasta F5/T-502 — solo le
