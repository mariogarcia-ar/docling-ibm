...
| [`CONC.md`](CONC.md) | `voucherflow/conclusion/` | Reglas cruzadas → búsqueda de evidencia adicional → agente IA → HITL → consolidación | 🟡 En implementación (T-501/T-502/T-503 hechas: reglas cruzadas, búsqueda acotada y consolidación del `VoucherResult`; T-504..T-507 pendientes) | F5 (T-501..T-507) |
...
> en **🟡 En implementación** (T-501/T-502/T-503 hechos: reglas cruzadas de la
> pasada 2, búsqueda acotada de evidencia y consolidación del `VoucherResult`) y
> **`RULES.md`** está 🟡 con el motor completo hasta F5/T-502 — solo le faltan las
> reglas cruzadas de la casuística HITL (post-MVP).
