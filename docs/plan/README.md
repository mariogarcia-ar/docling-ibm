...
| 03 | [`03-arquitectura-solucion.md`](03-arquitectura-solucion.md) · carpeta [`03-arquitectura/`](03-arquitectura/) ([README](03-arquitectura/README.md) con seguimiento por módulo) | SA | Arquitectura (C4), componentes de la librería, cliente, modelos de datos, secuencias + archivo de seguimiento (tracking) por módulo |
...
| 07 | [`07-extracciones-esperadas.md`](07-extracciones-esperadas.md) | BA/SA/QA | 🟡 **Especificación cerrada** (no implementada): dataset versionado de lecturas de referencia en `tests/expected-extraction/` para comparar el pipeline local contra un modelo externo. ⚠️ Mide **acuerdo**, no exactitud: la referencia tiene 5 de 28 CUIT mal leídos |
