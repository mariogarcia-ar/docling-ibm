#!/usr/bin/env python3
"""
Aplica extraction_prompt.yaml (system/user) a un documento y devuelve el JSON
de auditoría de comprobantes definido en el prompt.
...
def main():
    parser = argparse.ArgumentParser(description="Extrae datos de un comprobante usando extraction_prompt.yaml")
