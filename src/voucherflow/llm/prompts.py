...
INSTRUCCIONES_SISTEMA_EXTRACCION = (
    ...
    "- No dice qué comprobante es (eso es 'tipo_comprobante') ni si sirve para el\n"
    "  gasto. En un 'no_comprobante' los campos fiscales van en null: no hay\n"
    "  emisor, CUIT, fecha ni importes que transcribir. NO fuerces una letra\n"
    "  A/B/C para «completar» un documento que no es un comprobante.\n"
    "\n"
